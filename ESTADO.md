...
**Capítulo 1 completo.** Los tres bloques vistos: 7/8, 7/8 y 8/8.

**Siguiente: tarea 1.4** — consolidación del capítulo 1. Ronda mixta de 10 preguntas sobre los tres bloques (criterio ≥8/10). Es la primera prueba con separación temporal real respecto al bloque A, así que mide retención, no memoria reciente.

Primera tarea del nuevo formato: se trabaja en **conversación propia** (`Tarea 1.4`).

Progreso: **7 de 43 tareas** completadas.
...
**Seguimiento:** el mini-test de recuperación de los bloques A y B (5/5) incluía deliberadamente las dos casillas falladas antes — testware por actividad y tarea por rol — y ambas salieron bien. El bloque C cerró con 8/8, sin ningún fallo de clasificación. **Pendiente de confirmar en la consolidación 1.4**, que es la primera con separación temporal real respecto al bloque A.
